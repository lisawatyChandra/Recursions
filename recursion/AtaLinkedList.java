...
public class AtaLinkedList {
    ...
    private Double sumRecursive(AtaNode head) {
        if (head == null) {
            return 0.0;
        }
...
private AtaLinkedList reverseRecursive(AtaNode head) {
    if (head == null) {
        return new AtaLinkedList();
    }

    AtaLinkedList reversedList = reverseRecursive(head.getNext());
    ...
    public static void main(String[] args) {
        AtaLinkedList linkedList = new AtaLinkedList();
